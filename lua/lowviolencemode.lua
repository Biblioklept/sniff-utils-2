-- ORIGINAL MOD: https://modworkshop.net/mod/14602
-- Has been slightly edited because it had issues with the settings system

dofile(ModPath .. "core.lua")
if SniffUtils:GetOption("low_violence") then
	if RequiredScript == "lib/managers/enemymanager" then
		...
		old_limit = EnemyManager.corpse_limit
	end
